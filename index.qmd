...
![](Images/2_pt_mean.png){.absolute bottom=400 right=50 width="350" height="270"}
...
- Architecture: 
  ...
  - Hidden Layers: $64,32,32,32,8$
  - Output Size: $3$


![](Images/3_pt_mean.png){.absolute bottom=400 right=50 width="350" height="270"}
...
![](Images/4_pt_mean.png){.absolute bottom=400 right=50 width="350" height="270"}
